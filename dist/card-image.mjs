(function(){"use strict";try{if(typeof document!="undefined"){var e=document.createElement("style");e.appendChild(document.createTextNode(".cdx-card-image{margin:1em auto;background-color:#f8f8f8;color:#000;border-radius:8px;padding:20px}.cdx-card-image__value{font-size:54px;margin-bottom:10px;outline:none!important}.cdx-card-image__title{font-size:18px;margin-bottom:20px;outline:none!important}.cdx-card-image__description{font-size:14px;color:#333;outline:none!important}.cdx-card-image--left{text-align:left}.cdx-card-image--center{text-align:center}.cdx-card-image--right{text-align:right}")),document.head.appendChild(e)}}catch(t){console.error("vite-plugin-css-injected-by-js",t)}})();
var c = Object.defineProperty;
var d = (l, e, t) => e in l ? c(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t;
var a = (l, e, t) => (d(l, typeof e != "symbol" ? e + "" : e, t), t);
class r {
  constructor({ data: e, config: t, api: i, block: s, readOnly: n }) {
    a(this, "api");
    a(this, "block");
    a(this, "readOnly");
    a(this, "_data");
    a(this, "config");
    a(this, "nodes");
    a(this, "valuePlaceholder");
    a(this, "titlePlaceholder");
    a(this, "descriptionPlaceholder");
    a(this, "aligns", [
      {
        name: "left",
        title: "Align left",
    ...
    this.config = t, this.api = i, this.block = s, this.readOnly = n, this.valuePlaceholder = t.valuePlaceholder || "Add image value", this.titlePlaceholder = t.titlePlaceholder || "Add title", this.descriptionPlaceholder = t.descriptionPlaceholder || "Add description", this.data = e, this.nodes = {
      wrapper: null,
      value: null,
      title: null,
      description: null
  ...
  updateAlign(e) {
    ...
    this._data.align === e && ((t = this.nodes.wrapper) == null ? void 0 : t.classList.contains(this.classes.wrapperForAlignType(e))) || (this._data.align = e, this.aligns.forEach((i) => {
      var s;
      (s = this.nodes.wrapper) == null || s.classList.toggle(this.classes.wrapperForAlignType(i.name), this._data.align === i.name);
    }));
  }
  make(e, t = [], i = {}) {
